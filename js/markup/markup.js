...
var Overlay = {
    ...
    init:function(config){
        ...
        var currentImageIndex = parseInt(Markup.cookie.get('mk_img_current',0));
    ...
    configDiv:function(){
        ...
        div.css({
            ...
            background:"url("+imgPath+") center top no-repeat",
            top:Markup.cookie.get('mk_top',0)+'px',
            left:Markup.cookie.get('mk_left',0)+'px',
            display:'none',
            position:'absolute',
            'z-index':9999,
            opacity:'0.5'
    ...
    nextImage:function(){
        ...
        Markup.cookie.set('mk_img_current',index);
    ...
    resetPosition:function(){
        ...
        Markup.cookie.set('mk_left',0);
        Markup.cookie.set('mk_top',0);
    },
    defaults:{
        basePath:'overlays/'
    }
...
Markup.prototype.init = function(config){
